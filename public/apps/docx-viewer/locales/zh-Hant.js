...
I18n.register('zh-Hant', {
  ...
  'empty.title': '拖拉 .docx 檔到頁面任意位置',
  'empty.hint': '檔案會上傳到 <code>/upload/docx-viewer</code>，同名直接覆寫；<br />或<u>點此選擇檔案</u>。支援 <code>.docx</code>。<br />也可用 <code>?docx=&lt;路徑&gt;</code> 直接開啟。',
  'drop.text': '放開以上傳到 /upload/docx-viewer',
  'side.header': '檔案清單',
  ...
  'tool.lang': '語言',
  'tool.clear': '清空 /upload/docx-viewer',
  'tool.download': '下載原始檔',
  ...
  'confirm.clear': '確定要清空 /upload/docx-viewer 下的所有檔案嗎？此動作無法復原。'
}, '繁體中文');
